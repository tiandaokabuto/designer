  ...
  return (
    ...
    >
      <div style={{ overflowY: 'scroll', height: '300px' }}>
        <h1>
          <strong>软件许可协议</strong>
        </h1>
        <p>甲方：广州市申迪计算机系统有限公司</p>
        ...
        <p>
          ...
          (a)以源码形式披露或发布；
          (b)为生成衍生作品和/或发布衍生作品需要由使用者向第三方授权；或
          (c)再发布免费，才能使用、修改和/或发布。
          <br />
          5.
        ...
        <p>
          ...
          <br />
          2. 除本协议另有约定外,乙方不得在本协议期限内：
          （1）将软件及其修改或衍生作品全部或部分转让、授权、转租
          、分许可、再许可给任何第三方或让第三方接触；
          （2）对软件进行反编译、反汇编、反向工程、分解拆卸及从事其他任何试图获得软件源代码的行为。
          <br />
          3.
          甲方授权给乙方的软件中可能包含开源软件，乙方对开源软件的使用应该符合如下要求：
          （1）遵守相应的开源协议规定，开源协议的约定优于本协议的约定；
          （2）保留开源软件中原有的许可声明和版权、专利、商标情况等标识；
          （3）任何情況下，乙方保证不会使软件中不是开源软件的部分面临必须开源的风险。
          <br />
          4.
